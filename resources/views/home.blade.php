        ...
        <div class="mt-2 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div
                ...
                <div class="aspect-square bg-gray-100 rounded-xl mb-4 overflow-hidden relative">
                    <div class="absolute inset-0 flex items-center justify-center text-gray-400 font-medium">New Arrival
                    </div>
                </div>
                <div class="p-4">
                    <h3 class="font-bold text-gray-900">Minimalist Desk Lamp</h3>
                    <p class="text-sm text-gray-500">$89.00</p>
                </div>
            </div>
            <div
                class="bg-white p-2 rounded-2xl shadow-sm border border-gray-100 group cursor-pointer hover:shadow-md transition-all">
                <div class="aspect-square bg-gray-100 rounded-xl mb-4 overflow-hidden relative">
                    <div class="absolute inset-0 flex items-center justify-center text-gray-400 font-medium">Best Seller
                    </div>
                </div>
                <div class="p-4">
                    <h3 class="font-bold text-gray-900">Ceramic Coffee Mug</h3>
                    <p class="text-sm text-gray-500">$24.00</p>
                </div>
            </div>
            <div
                class="bg-white p-2 rounded-2xl shadow-sm border border-gray-100 group cursor-pointer hover:shadow-md transition-all">
                <div class="aspect-square bg-gray-100 rounded-xl mb-4 overflow-hidden relative">
                    <div class="absolute inset-0 flex items-center justify-center text-gray-400 font-medium">Limited Edition
                    </div>
                </div>
                <div class="p-4">
                    <h3 class="font-bold text-gray-900">Premium Leather Notebook</h3>
